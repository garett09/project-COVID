...
$jsonHistorial = file_get_contents('https://disease.sh/v3/covid-19/historical/all');
    ...
    <div class="h-100 midnight-blue pa3 ph0-l pv6-l">
        <div class="center mw7">
            ...
            <section class="country-table">
                ...
                <?php
                $json = file_get_contents("https://disease.sh/v3/covid-19/countries");
            ...
            <footer class="">
                <div class="mt1">
                    <a href="https://garett09.tech" title="Adrian Sian" class="f4 dib pr2 mid-gray dim">👨 Made by Adrian Sian</a>
                    <a href="https://github.com/disease-sh/API" title="Data Source" class="f4 dib pr2 mid-gray dim">📊 Data Source</a>
                </div>
            </footer>
        </div>
    </div>
